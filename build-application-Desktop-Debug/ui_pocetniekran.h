...
public:
    ...
    void setupUi(QMainWindow *PocetniEkran)
    {
        ...
        pushButton->setMinimumSize(QSize(300, 55));
        pushButton->setMaximumSize(QSize(300, 55));
        pushButton->setStyleSheet(QString::fromUtf8("background-color:  #800020"));
    ...
    void retranslateUi(QMainWindow *PocetniEkran)
    {
        ...
        pushButton->setText(QApplication::translate("PocetniEkran", "Pokreni igru", nullptr));
    } // retranslateUi
