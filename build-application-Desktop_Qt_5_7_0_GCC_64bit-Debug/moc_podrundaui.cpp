...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_podrundaui_t, stringdata0) + ofs \
...
const QMetaObject podrundaui::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_podrundaui.data,
      qt_meta_data_podrundaui,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *podrundaui::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_podrundaui.stringdata0))
        return static_cast<void*>(const_cast< podrundaui*>(this));
