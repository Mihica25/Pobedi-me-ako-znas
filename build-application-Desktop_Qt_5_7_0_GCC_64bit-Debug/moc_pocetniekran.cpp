...
const QMetaObject PocetniEkran::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_PocetniEkran.data,
      qt_meta_data_PocetniEkran,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PocetniEkran::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PocetniEkran.stringdata0))
        return static_cast<void*>(const_cast< PocetniEkran*>(this));
