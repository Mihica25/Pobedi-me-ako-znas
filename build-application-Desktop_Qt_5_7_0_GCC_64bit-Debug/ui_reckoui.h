...
public:
    ...
    void setupUi(QMainWindow *ReckoUI)
    {
        if (ReckoUI->objectName().isEmpty())
            ReckoUI->setObjectName(QStringLiteral("ReckoUI"));
        ...
        pbPotvrdi1->setObjectName(QStringLiteral("pbPotvrdi1"));
        ...
        pbPotvrdi2->setObjectName(QStringLiteral("pbPotvrdi2"));
        ...
        pbPotvrdi3->setObjectName(QStringLiteral("pbPotvrdi3"));
        ...
        pbPotvrdi4->setObjectName(QStringLiteral("pbPotvrdi4"));
        ...
        pbPotvrdi5->setObjectName(QStringLiteral("pbPotvrdi5"));
        ...
        leTimer->setObjectName(QStringLiteral("leTimer"));
        ...
        leBodovi->setObjectName(QStringLiteral("leBodovi"));
        ...
        resenje->setObjectName(QStringLiteral("resenje"));
    ...
    {
        ReckoUI->setWindowTitle(QApplication::translate("ReckoUI", "Recko", 0));
        pbPotvrdi1->setText(QApplication::translate("ReckoUI", "Potvrdi", 0));
        pbPotvrdi2->setText(QApplication::translate("ReckoUI", "Potvrdi", 0));
        pbPotvrdi3->setText(QApplication::translate("ReckoUI", "Potvrdi", 0));
        pbPotvrdi4->setText(QApplication::translate("ReckoUI", "Potvrdi", 0));
        pbPotvrdi5->setText(QApplication::translate("ReckoUI", "Potvrdi", 0));
        label->setText(QApplication::translate("ReckoUI", "Poeni", 0));
    } // retranslateUi
