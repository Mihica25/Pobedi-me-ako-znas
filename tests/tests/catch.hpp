...
// As of this writing, IBM XL's implementation of __builtin_constant_p has a
// bug which results in calls to destructors being emitted for each temporary,
...
// Enable async processing, as -pthread is specified or no additional linking
// is required
...
template <typename T>
T const &
operator+ (T const &value, StreamEndStop)
{
  return value;
}
}
...
public: // operators
  ...
  auto
  operator!= (StringRef const &other) const noexcept -> bool
  {
	return !(*this == other);
  }

  auto
  operator[] (size_type index) const noexcept -> char
  {
	assert (index < m_size);
...
public: // substrings and searches
  ...
  constexpr auto
  isNullTerminated () const noexcept -> bool
  {
...
#define INTERNAL_CATCH_REMOVE_PARENS_11_ARG(_0, _1, _2, _3, _4, _5, _6, _7,   \
											_8, _9, _10)                      \
  INTERNAL_CATCH_REMOVE_PARENS (_0),                                          \
	  INTERNAL_CATCH_REMOVE_PARENS_10_ARG (_1, _2, _3, _4, _5, _6, _7, _8,    \
										   _9, _10)
...
template <typename C>
auto
makeTestInvoker (void (C::*testAsMethod) ()) noexcept -> ITestInvoker *
{
...
public:
  ...
  template <typename T>
  auto
  operator<< (T const &value) -> ReusableStringStream &
  {
	*m_oss << value;
	return *this;
  }
...
inline id
performOptionalSelector (id obj, SEL sel)
{
...
template <typename T>
std::string
rawMemoryToString (const T &object)
{
...
std::string
rangeToString (InputIterator first, Sentinel last)
{
  ReusableStringStream rss;
  rss << "{ ";
  if (first != last)
...
{
  static std::string
  convert (const std::pair<T1, T2> &pair)
  {
	ReusableStringStream rss;
...
{
  static std::string
  convert (const std::optional<T> &optional)
  {
	ReusableStringStream rss;
...
{
  static void
  print (const Tuple &tuple, std::ostream &os)
  {
...
{
  static std::string
  convert (const std::tuple<Types...> &tuple)
  {
	ReusableStringStream rss;
	rss << '{';
...
{
  static std::string
  convert (const std::variant<Elements...> &variant)
  {
...
std::string
rangeToString (Range const &range)
{
...
{
  auto
  isBinaryExpression () const -> bool
  {
	return m_isBinaryExpression;
  }
  auto
  getResult () const -> bool
  {
	return m_result;
  }
...
class BinaryExpr : public ITransientExpression
{
  ...
  void
  streamReconstructedExpression (std::ostream &os) const override
  {
...
template <typename LhsT, typename RhsT>
auto
compareEqual (LhsT const &lhs, RhsT const &rhs) -> bool
{
  return static_cast<bool> (lhs == rhs);
}
template <typename T>
auto
compareEqual (T *const &lhs, int rhs) -> bool
{
  return lhs == reinterpret_cast<void const *> (rhs);
}
template <typename T>
auto
compareEqual (T *const &lhs, long rhs) -> bool
{
  return lhs == reinterpret_cast<void const *> (rhs);
}
template <typename T>
auto
compareEqual (int lhs, T *const &rhs) -> bool
{
  return reinterpret_cast<void const *> (lhs) == rhs;
}
template <typename T>
auto
compareEqual (long lhs, T *const &rhs) -> bool
{
  return reinterpret_cast<void const *> (lhs) == rhs;
}
...
template <typename LhsT, typename RhsT>
auto
compareNotEqual (LhsT const &lhs, RhsT &&rhs) -> bool
{
  return static_cast<bool> (lhs != rhs);
}
template <typename T>
auto
compareNotEqual (T *const &lhs, int rhs) -> bool
{
  return lhs != reinterpret_cast<void const *> (rhs);
}
template <typename T>
auto
compareNotEqual (T *const &lhs, long rhs) -> bool
{
  return lhs != reinterpret_cast<void const *> (rhs);
}
template <typename T>
auto
compareNotEqual (int lhs, T *const &rhs) -> bool
{
  return reinterpret_cast<void const *> (lhs) != rhs;
}
template <typename T>
auto
compareNotEqual (long lhs, T *const &rhs) -> bool
{
  return reinterpret_cast<void const *> (lhs) != rhs;
}
...
public:
  ...
  auto
  operator== (RhsT const &rhs) -> BinaryExpr<LhsT, RhsT const &> const
  {
  ...
  template <typename RhsT>
  auto
  operator&& (RhsT const &) -> BinaryExpr<LhsT, RhsT const &> const
  {
  ...
  auto
  makeUnaryExpr () const -> UnaryExpr<LhsT>
  {
...
template <typename T>
void
handleExpression (ExprLhs<T> const &expr)
{
...
struct Decomposer
{
  template <typename T>
  auto
  operator<= (T const &lhs) -> ExprLhs<T const &>
  {
	return ExprLhs<T const &>{ lhs };
  }

  auto
  operator<= (bool value) -> ExprLhs<bool>
  {
...
struct IResultCapture
{
  ...
  virtual void handleExpr (AssertionInfo const &info,
	  ...
	  = 0;
  virtual void
  handleMessage (AssertionInfo const &info, ResultWas::OfType resultType,
...
public:
  ...
  template <typename T>
  void
  handleExpr (ExprLhs<T> const &expr)
  {
...
public:
  ...
  template <typename T>
  void
  captureValues (size_t index, T const &value)
  {
  ...
  void
  captureValues (size_t index, T const &value, Ts const &... values)
  {
	captureValue (index, Catch::Detail::stringify (value));
  ...
  do                                                                          \
	{                                                                         \
	  ...
	  catchAssertionHandler.handleMessage (                                   \
		  messageType, (Catch::MessageStream ()                               \
...
public:
  ...
  template <typename T, typename = typename std::enable_if<
							std::is_constructible<double, T>::value>::type>
  friend bool
  operator== (const T &lhs, Approx const &rhs)
  {
  ...
  template <typename T, typename = typename std::enable_if<
							std::is_constructible<double, T>::value>::type>
  friend bool
  operator== (Approx const &lhs, const T &rhs)
  {
  ...
  template <typename T, typename = typename std::enable_if<
							std::is_constructible<double, T>::value>::type>
  friend bool
  operator!= (T const &lhs, Approx const &rhs)
  {
  ...
  template <typename T, typename = typename std::enable_if<
							std::is_constructible<double, T>::value>::type>
  friend bool
  operator!= (Approx const &lhs, T const &rhs)
  {
	return !operator== (rhs, lhs);
  }
...
{
  bool
  match (ArgT const &arg) const override
  {
...
struct ContainsElementMatcher : MatcherBase<std::vector<T, Alloc> >
{
  ...
  bool
  match (std::vector<T, Alloc> const &v) const override
  {
	for (auto const &el : v)
	  {
		if (el == m_comparator)
...
struct ContainsMatcher : MatcherBase<std::vector<T, AllocMatch> >
{
  ...
  bool
  match (std::vector<T, AllocMatch> const &v) const override
  {
...
struct EqualsMatcher : MatcherBase<std::vector<T, AllocMatch> >
{
  ...
  match (std::vector<T, AllocMatch> const &v) const override
  {
	...
	// to using !=. but could be specialised for, e.g. std::vector<T, Alloc>
	// etc
...
template <typename ArgT, typename MatcherT>
auto
makeMatchExpr (ArgT const &arg, MatcherT const &matcher,
...
template <typename T>
GeneratorWrapper<T>
values (std::initializer_list<T> values)
{
  return GeneratorWrapper<T> (
...
template <typename T> class Generators : public IGenerator<T>
{
  ...
  void
  populate (GeneratorWrapper<T> &&generator)
  {
  ...
  void
  populate (U &&valueOrGenerator, Gs &&... moreGenerators)
  {
...
auto
makeGenerators (GeneratorWrapper<T> &&generator, Gs &&... moreGenerators)
	-> Generators<T>
{
...
template <typename T>
auto
makeGenerators (GeneratorWrapper<T> &&generator) -> Generators<T>
{
  return Generators<T> (std::move (generator));
}
template <typename T, typename... Gs>
auto
makeGenerators (T &&val, Gs &&... moreGenerators) -> Generators<T>
{
...
auto
makeGenerators (as<T>, U &&val, Gs &&... moreGenerators) -> Generators<T>
{
...
//       return type. Yeah.
auto
generate (StringRef generatorName, SourceLineInfo const &lineInfo,
...
template <typename T>
GeneratorWrapper<T>
take (size_t target, GeneratorWrapper<T> &&generator)
{
  return GeneratorWrapper<T> (
...
template <typename T>
GeneratorWrapper<T>
range (T const &start, T const &end, T const &step)
{
...
template <typename T>
GeneratorWrapper<T>
range (T const &start, T const &end)
{
...
from_range (InputIterator from, InputSentinel to)
{
...
GeneratorWrapper<ResultType>
from_range (Container const &cnt)
{
  return GeneratorWrapper<ResultType> (
...
inline std::string
getAnnotation (Class cls, std::string const &annotationName,
...
struct StringHolder : MatcherBase<NSString *>
{
  ...
  bool
  match (NSString *str) const override
  {
	return false;
  }
...
struct IStreamingReporter
{
  ...
  virtual void
  reportInvalidArguments (std::string const &)
  {
  }
  ...
  virtual void
  benchmarkStarting (BenchmarkInfo const &)
  {
  }
  virtual void
  benchmarkEnded (BenchmarkStats<> const &)
  {
  }
  virtual void
  benchmarkFailed (std::string const &)
  {
  }
#endif // CATCH_CONFIG_ENABLE_BENCHMARKING
...
template <typename DerivedT> struct StreamingReporterBase : IStreamingReporter
{
  ...
  void
  reportInvalidArguments (std::string const &) override
  {
  }

  void
  testRunStarting (TestRunInfo const &_testRunInfo) override
  {
	currentTestRunInfo = _testRunInfo;
  }

  void
  testGroupStarting (GroupInfo const &_groupInfo) override
  {
  ...
  void
  sectionEnded (SectionStats const & /* _sectionStats */) override
  {
  ...
  void
  skipTest (TestCaseInfo const &) override
  {
...
template <typename DerivedT> struct CumulativeReporterBase : IStreamingReporter
{
  ...
  struct SectionNode
  {
	...
	bool
	operator== (SectionNode const &other) const
	{
	  return stats.sectionInfo.lineInfo == other.stats.sectionInfo.lineInfo;
	}
	bool
	operator== (std::shared_ptr<SectionNode> const &other) const
	{
  ...
  struct BySectionInfo
  {
	...
	bool
	operator() (std::shared_ptr<SectionNode> const &node) const
	{
  ...
  void
  testRunStarting (TestRunInfo const &) override
  {
  }
  void
  testGroupStarting (GroupInfo const &) override
  {
  }

  void
  testCaseStarting (TestCaseInfo const &) override
  {
  }

  void
  sectionStarting (SectionInfo const &sectionInfo) override
  {
  ...
  void
  sectionEnded (SectionStats const &sectionStats) override
  {
	assert (!m_sectionStack.empty ());
  ...
  void
  testCaseEnded (TestCaseStats const &testCaseStats) override
  {
  ...
  void
  testGroupEnded (TestGroupStats const &testGroupStats) override
  {
  ...
  void
  testRunEnded (TestRunStats const &testRunStats) override
  {
...
public:
  ...
  XmlWriter &endElement (XmlFormatting fmt
						 = XmlFormatting::Newline | XmlFormatting::Indent);
...
inline auto
invoke_deoptimized (Fn &&fn, Args &&... args) -> typename std::enable_if<
...
Detail::CompleteType_t<FunctionReturnType<Fun> >
user_code (Fun &&fun)
{
...
private:
  template <typename Fun>
  void
  measure (Fun &&fun, std::false_type)
  {
...
/// We need to reinvent std::function because every piece of code that might
/// add overhead in a measurement context needs to have consistent performance
...
private:
  ...
  template <typename Fun> struct model : public callable
  {
	...
	void
	call (Chronometer meter) const override
	{
	  call (meter, is_callable<Fun (Chronometer)> ());
	}
	void
	call (Chronometer meter, std::true_type) const
	{
	  fun (meter);
	}
	void
	call (Chronometer meter, std::false_type) const
	{
	  meter.measure (fun);
	}
...
public:
  ...
  BenchmarkFunction &
  operator= (BenchmarkFunction &&that)
  {
	f = std::move (that.f);
	return *this;
  }
  ...
  BenchmarkFunction &
  operator= (BenchmarkFunction const &that)
  {
  ...
  void
  operator() (Chronometer meter) const
  {
	f->call (meter);
  }
...
template <typename Fun>
repeater<typename std::decay<Fun>::type>
repeat (Fun &&fun)
{
...
classify_outliers (Iterator first, Iterator last)
{
...
sample
resample (URng &rng, int resamples, Iterator first, Iterator last,
		  Estimator &estimator)
{
  auto n = last - first;
...
Estimate<double>
bootstrap (double confidence_level, Iterator first, Iterator last,
		   sample const &resample, Estimator &&estimator)
{
  ...
  auto cumn
	  = [n] (double x) -> int { return std::lround (normal_cdf (x) * n); };
...
template <typename Clock>
Environment<FloatDuration<Clock> >
measure_environment ()
{
...
analyse (const IConfig &cfg, Environment<Duration>, Iterator first,
		 Iterator last)
{
  if (!cfg.benchmarkNoAnalysis ())
  ...
  else
	{
	  ...
	  return {
		std::move (samples), Estimate<Duration>{ mean, mean, mean, 0.0 },
...
private:
  ...
  template <typename U>
  void
  destruct_on_exit (typename std::enable_if<Destruct, U>::type * = 0)
  {
	destruct<true> ();
  }
  // Otherwise, don't
...
struct NameAndLocation
{
  ...
  friend bool
  operator== (NameAndLocation const &lhs, NameAndLocation const &rhs)
  {
...
double
standard_deviation (std::vector<double>::iterator first,
					std::vector<double>::iterator last)
{
...
double
outlier_variance (Estimate<double> mean, Estimate<double> stddev, int n)
{
...
bootstrap_analysis
analyse_samples (double confidence_level, int n_resamples,
				 std::vector<double>::iterator first,
				 std::vector<double>::iterator last)
{
  CATCH_INTERNAL_START_WARNINGS_SUPPRESSION
...
bool
Approx::equalityComparisonImpl (const double other) const
{
...
void
Approx::setEpsilon (double newEpsilon)
{
...
std::string
StringMaker<Catch::Detail::Approx>::convert (
...
{
auto
operator<< (std::ostream &os, ITransientExpression const &expr)
	-> std::ostream &
{
...
void
AssertionHandler::handleExpr (ITransientExpression const &expr)
{
  m_resultCapture.handleExpr (m_assertionInfo, expr, m_reaction);
}
void
AssertionHandler::handleMessage (ResultWas::OfType resultType,
								 StringRef const &message)
{
...
auto
AssertionHandler::allowThrows () const -> bool
{
...
void
handleExceptionMatchExpr (AssertionHandler &handler, std::string const &str,
						  StringRef const &matcherString)
{
...
std::string
AssertionResultData::reconstructExpression () const
{
...
bool
AssertionResult::succeeded () const
{
...
ResultWas::OfType
AssertionResult::getResultType () const
{
  return m_resultData.resultType;
}

bool
AssertionResult::hasExpression () const
{
...
std::string
AssertionResult::getExpression () const
{
...
std::string
AssertionResult::getExpressionInMacro () const
{
  std::string expr;
...
std::string
AssertionResult::getExpandedExpression () const
{
...
std::string
AssertionResult::getMessage () const
{
  return m_resultData.message;
}
SourceLineInfo
AssertionResult::getSourceInfo () const
{
  return m_info.lineInfo;
}

StringRef
AssertionResult::getTestMacroName () const
{
						  ...
						  StringRef const &matcherString)
{
  ...
  MatchExpr<std::string, StringMatcher const &> expr (exceptionMessage,
...
inline auto
isBreakableBefore (char c) -> bool
{
  static std::string chars = "[({<|";
  return chars.find (c) != std::string::npos;
}
inline auto
isBreakableAfter (char c) -> bool
{
  static std::string chars = "])}>.,:;*+-=&/\\";
  return chars.find (c) != std::string::npos;
}
...
public:
  class iterator
  {
	...
	auto
	line () const -> std::string const &
	{
	  return m_column.m_strings[m_stringIndex];
	}

	auto
	isBoundary (size_t at) const -> bool
	{
	  assert (at > 0);
	  assert (at <= line ().size ());
	...
	auto
	addIndentAndSuffix (std::string const &plain) const -> std::string
	{
  ...
  public:
	...
	auto
	operator== (iterator const &other) const -> bool
	{
  ...
  auto
  indent (size_t newIndent) -> Column &
  {
	m_indent = newIndent;
	return *this;
  }
  auto
  initialIndent (size_t newIndent) -> Column &
  {
...
public:
  ...
  auto
  operator+= (Column const &col) -> Columns &
  {
...
inline auto
Column::operator+ (Column const &other) -> Columns
{
  Columns cols;
  cols += *this;
  cols += other;
...
// to strings as a single string may encode an option + its argument if the :
// or = form is used
...
protected:
  ...
  auto
  operator= (ResultValueBase const &other) -> ResultValueBase &
  {
	if (m_type == ResultBase::Ok)
	  m_value.~T ();
...
public:
  ...
  static auto
  logicError (std::string const &message) -> BasicResult
  {
	return { ResultBase::LogicError, message };
  }
  static auto
  runtimeError (std::string const &message) -> BasicResult
  {
...
public:
  ...
  auto
  type () const -> ParseResultType
  {
	return m_type;
  }
  auto
  remainingTokens () const -> TokenStream
  {
...
template <typename T>
inline auto
convertInto (std::string const &source, T &target) -> ParserResult
{
  std::stringstream ss;
  ss << source;
  ss >> target;
...
inline auto
convertInto (std::string const &source, std::string &target) -> ParserResult
{
  target = source;
  return ParserResult::ok (ParseResultType::Matched);
}
inline auto
convertInto (std::string const &source, bool &target) -> ParserResult
{
...
template <typename T>
inline auto
convertInto (std::string const &source, CLARA_CONFIG_OPTIONAL_TYPE<T> &target)
	-> ParserResult
{
  T temp;
...
template <typename T> struct BoundValueRef : BoundValueRefBase
{
  ...
  auto
  setValue (std::string const &arg) -> ParserResult override
  {
...
template <typename T> struct BoundValueRef<std::vector<T> > : BoundValueRefBase
{
  ...
  auto
  isContainer () const -> bool override
  {
	return true;
  }
...
struct BoundFlagRef : BoundFlagRefBase
{
  ...
  auto
  setFlag (bool flag) -> ParserResult override
  {
	m_ref = flag;
	return ParserResult::ok (ParseResultType::Matched);
  }
...
template <typename ReturnType> struct LambdaInvoker
{
  ...
  static auto
  invoke (L const &lambda, ArgType const &arg) -> ParserResult
  {
	return lambda (arg);
  }
};
...
inline auto
invokeLambda (L const &lambda, std::string const &arg) -> ParserResult
{
  ArgType temp{};
  auto result = convertInto (arg, temp);
  return !result
			 ? result
			 : LambdaInvoker<
				 typename UnaryLambdaTraits<L>::ReturnType>::invoke (lambda,
																	 temp);
}
...
public:
  ...
  auto
  operator() (std::string const &description) -> DerivedT &
  {
  ...
  auto
  cardinality () const -> size_t override
  {
...
class ExeName : public ComposableParserImpl<ExeName>
{
  ...
  template <typename LambdaT>
  static auto
  makeRef (LambdaT const &lambda) -> std::shared_ptr<BoundValueRefBase>
  {
...
public:
  ...
  // specially
  auto
  parse (std::string const &, TokenStream const &tokens) const
  ...
  auto
  set (std::string const &newName) -> ParserResult
  {
...
inline auto
normaliseOpt (std::string const &optName) -> std::string
{
#ifdef CATCH_PLATFORM_WINDOWS
  if (optName[0] == '/')
...
public:
  ...
  auto
  operator[] (std::string const &optName) -> Opt &
  {
  ...
  auto
  getHelpColumns () const -> std::vector<HelpColumns>
  {
	std::ostringstream oss;
	bool first = true;
  ...
  auto
  isMatch (std::string const &optToken) const -> bool
  {
  ...
  auto
  validate () const -> Result override
  {
	if (m_optNames.empty ())
...
struct Parser : ParserBase
{
  ...
  auto
  operator|= (Parser const &other) -> Parser &
  {
  ...
  template <typename T>
  auto
  operator| (T const &other) const -> Parser
  {
  ...
  friend auto
  operator<< (std::ostream &os, Parser const &parser) -> std::ostream &
  {
  ...
  auto
  parse (std::string const &exeName, TokenStream const &tokens) const
	  -> InternalParseResult override
  {
...
template <typename T>
auto
ComposableParserImpl<DerivedT>::operator| (T const &other) const -> Parser
{
...
clara::Parser
makeCommandLineParser (ConfigData &config)
{
  ...
  auto cli
	  = ExeName (config.processName) | Help (config.showHelp)
		...
		| Opt (config.minDuration, "seconds")["-D"]["--min-duration"](
			"show test durations for tests taking at least the given number "
			"of seconds")
...
bool
Config::listTests () const
{
  return m_data.listTests;
}
bool
Config::listTestNamesOnly () const
{
  return m_data.listTestNamesOnly;
}
bool
Config::listTags () const
{
  return m_data.listTags;
}
bool
Config::listReporters () const
{
  return m_data.listReporters;
}

std::string
Config::getProcessName () const
{
  return m_data.processName;
}
std::string const &
Config::getReporterName () const
{
  return m_data.reporterName;
}

std::vector<std::string> const &
Config::getTestsOrTags () const
{
  return m_data.testsOrTags;
}
std::vector<std::string> const &
Config::getSectionsToRun () const
{
  return m_data.sectionsToRun;
}

TestSpec const &
Config::testSpec () const
{
  return m_testSpec;
}
bool
Config::hasTestFilters () const
{
  return m_hasTestFilters;
}

bool
Config::showHelp () const
{
...
bool
Config::includeSuccessfulResults () const
{
  return m_data.showSuccessfulTests;
}
bool
Config::warnAboutMissingAssertions () const
{
  return !!(m_data.warnings & WarnAbout::NoAssertions);
}
bool
Config::warnAboutNoTests () const
{
  return !!(m_data.warnings & WarnAbout::NoTests);
}
ShowDurations::OrNot
Config::showDurations () const
{
  return m_data.showDurations;
}
double
Config::minDuration () const
{
  return m_data.minDuration;
}
RunTests::InWhatOrder
Config::runOrder () const
{
  return m_data.runOrder;
}
unsigned int
Config::rngSeed () const
{
  return m_data.rngSeed;
}
UseColour::YesOrNo
Config::useColour () const
{
  return m_data.useColour;
}
bool
Config::shouldDebugBreak () const
{
  return m_data.shouldDebugBreak;
}
int
Config::abortAfter () const
{
  return m_data.abortAfter;
}
bool
Config::showInvisibles () const
{
  return m_data.showInvisibles;
}
Verbosity
Config::verbosity () const
{
  return m_data.verbosity;
}

bool
Config::benchmarkNoAnalysis () const
{
  return m_data.benchmarkNoAnalysis;
}
int
Config::benchmarkSamples () const
{
  return m_data.benchmarkSamples;
}
double
Config::benchmarkConfidenceInterval () const
{
  return m_data.benchmarkConfidenceInterval;
}
unsigned int
Config::benchmarkResamples () const
{
  return m_data.benchmarkResamples;
}
std::chrono::milliseconds
Config::benchmarkWarmupTime () const
{
...
public:
  ...
  void
  use (Colour::Code _colourCode) override
  {
	switch (_colourCode)
	  {
	  case Colour::None:
...
private:
  void
  setTextAttribute (WORD _textAttribute)
  {
...
private:
  void
  setColour (const char *_escapeCode)
  {
...
std::ostream &
operator<< (std::ostream &os, Colour const &)
{
  return os;
}
...
public: // IMutableContext
  void
  setResultCapture (IResultCapture *resultCapture) override
  {
	m_resultCapture = resultCapture;
  }
  void
  setRunner (IRunner *runner) override
  {
	m_runner = runner;
  }
  void
  setConfig (IConfigPtr const &config) override
  {
	m_config = config;
  }
...
{
void
writeToDebugConsole (std::string const &text)
{
...
void
formatReconstructedExpression (std::ostream &os, std::string const &lhs,
							   StringRef op, std::string const &rhs)
{
...
[[noreturn]] void
throw_logic_error (std::string const &msg)
{
  throw_exception (std::logic_error (msg));
}

[[noreturn]] void
throw_domain_error (std::string const &msg)
{
  throw_exception (std::domain_error (msg));
}

[[noreturn]] void
throw_runtime_error (std::string const &msg)
{
...
StringRef
extractInstanceName (StringRef enumInstance)
{
...
StringRef
EnumInfo::lookup (int value) const
{
...
makeEnumInfo (StringRef enumName, StringRef allValueNames,
			  std::vector<int> const &values)
{
...
void
ExceptionTranslatorRegistry::registerTranslator (
...
#if !defined(CATCH_CONFIG_DISABLE_EXCEPTIONS)
std::string
ExceptionTranslatorRegistry::translateActiveException () const
{
  try
	{
#ifdef __OBJC__
...
std::string
ExceptionTranslatorRegistry::tryTranslators () const
{
...
void
reportFatal (char const *const message)
{
...
std::ostream &
ReporterConfig::stream () const
{
  return *m_stream;
}
IConfigPtr
ReporterConfig::fullConfig () const
{
  return m_fullConfig;
}
...
TestCaseStats::TestCaseStats (TestCaseInfo const &_testInfo,
	...
	: testInfo (_testInfo), totals (_totals), stdOut (_stdOut),
	  stdErr (_stdErr), aborting (_aborting)
{
}
...
bool
IStreamingReporter::isMulti () const
{
  return false;
}
...
void
TagInfo::add (std::string const &spelling)
{
  ++count;
...
Option<std::size_t>
list (std::shared_ptr<Config> const &config)
{
...
std::string
ExceptionMessageMatcher::describe () const
{
...
bool
almostEqualUlps (FP lhs, FP rhs, uint64_t maxUlpDiff)
{
...
template <typename FP>
FP
step (FP start, FP direction, uint64_t steps)
{
...
void
write (std::ostream &out, FloatingPoint num)
{
  out << std::scientific
...
// But without the subtraction to allow for INFINITY in comparison
bool
WithinAbsMatcher::match (double const &matchee) const
{
  return (matchee + m_margin >= m_target) && (m_target + m_margin >= matchee);
}

std::string
WithinAbsMatcher::describe () const
{
...
bool
WithinUlpsMatcher::match (double const &matchee) const
{
  switch (m_type)
	{
...
std::string
WithinUlpsMatcher::describe () const
{
...
bool
WithinRelMatcher::match (double const &matchee) const
{
...
std::string
WithinRelMatcher::describe () const
{
...
std::string
CasedString::caseSensitivitySuffix () const
{
...
bool
EqualsMatcher::match (std::string const &source) const
{
...
bool
ContainsMatcher::match (std::string const &source) const
{
...
bool
StartsWithMatcher::match (std::string const &source) const
{
...
bool
EndsWithMatcher::match (std::string const &source) const
{
...
bool
RegexMatcher::match (std::string const &matchee) const
{
...
Contains (std::string const &str, CaseSensitive::Choice caseSensitivity)
{
...
StartsWith (std::string const &str, CaseSensitive::Choice caseSensitivity)
{
...
void
Capturer::captureValue (size_t index, std::string const &value)
{
...
auto
RedirectedStdOut::str () const -> std::string
{
  return m_rss.str ();
}
...
auto
RedirectedStdErr::str () const -> std::string
{
  return m_rss.str ();
}
...
uint32_t
rotate_right (uint32_t val, uint32_t count)
{
...
void
SimplePcg32::seed (result_type seed_)
{
  m_state = 0;
  (*this) ();
  m_state += seed_;
...
void
SimplePcg32::discard (uint64_t skip)
{
...
bool
operator== (SimplePcg32 const &lhs, SimplePcg32 const &rhs)
{
...
public: // IRegistryHub
  ...
  getReporterRegistry () const override
  {
	return m_reporterRegistry;
  }
  ITestCaseRegistry const &
  getTestCaseRegistry () const override
  {
  ...
  getTagAliasRegistry () const override
  {
...
public: // IMutableRegistryHub
  ...
  void
  registerListener (IReporterFactoryPtr const &factory) override
  {
	m_reporterRegistry.registerListener (factory);
  }
  void
  registerTest (TestCase const &testInfo) override
  {
	m_testCaseRegistry.registerTest (testInfo);
  }
  void
  registerTranslator (const IExceptionTranslator *translator) override
  {
	m_exceptionTranslatorRegistry.registerTranslator (translator);
  }
  void
  registerTagAlias (std::string const &alias, std::string const &tag,
					SourceLineInfo const &lineInfo) override
  {
	m_tagAliasRegistry.add (alias, tag, lineInfo);
  }
  void
  registerStartupException () noexcept override
  {
#if !defined(CATCH_CONFIG_DISABLE_EXCEPTIONS)
...
IReporterRegistry::Listeners const &
...
bool
isOk (ResultWas::OfType resultType)
{
  return (resultType & ResultWas::FailureBit) == 0;
}
bool
isJustInfo (int flags)
{
...
bool
shouldContinueOnFailure (int flags)
{
...
struct GeneratorTracker : TestCaseTracking::TrackerBase, IGeneratorTracker
{
  ...
  bool
  isGeneratorTracker () const override
  {
	return true;
  }
  auto
  hasGenerator () const -> bool override
  {
	return !!m_generator;
  }
  void
  ...
  auto
  getGenerator () const -> GeneratorBasePtr const & override
  {
	return m_generator;
  }
  void
  setGenerator (GeneratorBasePtr &&generator) override
  {
	m_generator = std::move (generator);
  }
};
...
void
RunContext::testGroupStarting (std::string const &testSpec,
							   std::size_t groupIndex, std::size_t groupsCount)
{
...
void
RunContext::testGroupEnded (std::string const &testSpec, Totals const &totals,
							std::size_t groupIndex, std::size_t groupsCount)
{
...
Totals
RunContext::runTest (TestCase const &testCase)
{
...
IConfigPtr
RunContext::config () const
{
  return m_config;
}

IStreamingReporter &
RunContext::reporter () const
{
  return *m_reporter;
}

void
RunContext::assertionEnded (AssertionResult const &result)
{
...
bool
RunContext::sectionStarted (SectionInfo const &sectionInfo, Counts &assertions)
{
...
bool
RunContext::testForMissingAssertions (Counts &assertions)
{
...
void
RunContext::sectionEnded (SectionEndInfo const &endInfo)
{
...
void
RunContext::sectionEndedEarly (SectionEndInfo const &endInfo)
{
...
#if defined(CATCH_CONFIG_ENABLE_BENCHMARKING)
void
RunContext::benchmarkPreparing (std::string const &name)
{
  m_reporter->benchmarkPreparing (name);
}
void
RunContext::benchmarkStarting (BenchmarkInfo const &info)
{
  m_reporter->benchmarkStarting (info);
}
void
RunContext::benchmarkEnded (BenchmarkStats<> const &stats)
{
  m_reporter->benchmarkEnded (stats);
}
void
RunContext::benchmarkFailed (std::string const &error)
{
...
void
RunContext::pushScopedMessage (MessageInfo const &message)
{
  m_messages.push_back (message);
}

void
RunContext::popScopedMessage (MessageInfo const &message)
{
  m_messages.erase (
...
void
RunContext::emplaceUnscopedMessage (MessageBuilder const &builder)
{
  m_messageScopes.emplace_back (builder);
}

std::string
RunContext::getCurrentTestName () const
{
...
bool
RunContext::lastAssertionPassed ()
{
...
void
RunContext::runCurrentTest (std::string &redirectedCout,
							std::string &redirectedCerr)
{
  auto const &testCaseInfo = m_activeTestCase->getTestCaseInfo ();
  SectionInfo testCaseSection (testCaseInfo.lineInfo, testCaseInfo.name);
...
void
RunContext::handleUnfinishedSections ()
{
...
void
RunContext::handleExpr (AssertionInfo const &info,
						ITransientExpression const &expr,
						AssertionReaction &reaction)
{
...
void
RunContext::reportExpr (AssertionInfo const &info,
						ResultWas::OfType resultType,
						ITransientExpression const *expr, bool negated)
{
...
void
RunContext::handleMessage (AssertionInfo const &info,
						   ResultWas::OfType resultType,
						   StringRef const &message,
						   AssertionReaction &reaction)
{
...
void
RunContext::handleUnexpectedExceptionNotThrown (AssertionInfo const &info,
												AssertionReaction &reaction)
{
...
void
RunContext::handleIncomplete (AssertionInfo const &info)
{
  m_lastAssertionInfo = info;
...
void
RunContext::handleNonExpr (AssertionInfo const &info,
						   ResultWas::OfType resultType,
						   AssertionReaction &reaction)
{
  m_lastAssertionInfo = info;
...
public:
  ...
  int
  run (int argc, CharT const *const argv[])
  {
...
void
applyFilenamesAsTags (Catch::IConfig const &config)
{
  auto &tests
...
int
Session::applyCommandLine (int argc, char const *const *argv)
{
  if (m_startupExceptions)
	return 1;
...
#if defined(CATCH_CONFIG_WCHAR) && defined(_WIN32) && defined(UNICODE)
int
Session::applyCommandLine (int argc, wchar_t const *const *argv)
{
...
void
Session::useConfigData (ConfigData const &configData)
{
...
void
Session::cli (clara::Parser const &newParser)
{
  m_cli = newParser;
}
ConfigData &
...
Session::runInternal ()
{
  ...
  CATCH_TRY
  {
	...
	return (std::min) (
		MaxExitCode, (std::max) (totals.error,
...
{
void
StartupExceptionRegistry::add (std::exception_ptr const &exception) noexcept
{
...
auto
makeStream (StringRef const &filename) -> IStream const *
{
  if (filename.empty ())
...
auto
ReusableStringStream::str () const -> std::string
{
...
bool
startsWith (std::string const &s, std::string const &prefix)
{
  return s.size () >= prefix.size ()
		 && std::equal (prefix.begin (), prefix.end (), s.begin ());
}
bool
startsWith (std::string const &s, char prefix)
{
...
bool
endsWith (std::string const &s, char suffix)
{
...
bool
replaceInPlace (std::string &str, std::string const &replaceThis,
				std::string const &withThis)
{
  bool replaced = false;
...
std::vector<StringRef>
splitStringRef (StringRef str, char delimiter)
{
...
auto
StringRef::c_str () const -> char const *
{
  CATCH_ENFORCE (
	  isNullTerminated (),
...
auto
StringRef::data () const noexcept -> char const *
{
  return m_start;
}

auto
StringRef::substr (size_type start, size_type size) const noexcept -> StringRef
{
  if (start < m_size)
	{
...
auto
StringRef::operator== (StringRef const &other) const noexcept -> bool
{
...
auto
operator<< (std::ostream &os, StringRef const &str) -> std::ostream &
{
  return os.write (str.data (), str.size ());
}

auto
operator+= (std::string &lhs, StringRef const &rhs) -> std::string &
{
...
TagAlias const *
TagAliasRegistry::find (std::string const &alias) const
{
...
void
TagAliasRegistry::add (std::string const &alias, std::string const &tag,
					   SourceLineInfo const &lineInfo)
{
...
bool
isReservedTag (std::string const &tag)
{
  return parseSpecialTag (tag) == TestCaseInfo::None && tag.size () > 0
		 && !std::isalnum (static_cast<unsigned char> (tag[0]));
}
void
enforceNotReservedTag (std::string const &tag, SourceLineInfo const &_lineInfo)
{
...
TestCase
makeTestCase (ITestInvoker *_testCase, std::string const &_className,
...
void
setTags (TestCaseInfo &testCaseInfo, std::vector<std::string> tags)
{
...
bool
TestCaseInfo::isHidden () const
{
  return (properties & IsHidden) != 0;
}
bool
TestCaseInfo::throws () const
{
  return (properties & Throws) != 0;
}
bool
TestCaseInfo::okToFail () const
{
  return (properties & (ShouldFail | MayFail)) != 0;
}
bool
TestCaseInfo::expectedToFail () const
{
  return (properties & (ShouldFail)) != 0;
}

std::string
TestCaseInfo::tagsAsString () const
{
  std::string ret;
  // '[' and ']' per tag
...
bool
TestCase::operator== (TestCase const &other) const
{
...
TestCaseInfo const &
TestCase::getTestCaseInfo () const
{
  return *this;
}
...
struct TestHasher
{
  ...
  uint32_t
  operator() (TestCase const &t) const
  {
...
bool
isThrowSafe (TestCase const &testCase, IConfig const &config)
{
  return !testCase.throws () || config.allowThrows ();
}

bool
matchTest (TestCase const &testCase, TestSpec const &testSpec,
		   IConfig const &config)
{
...
void
enforceNoDuplicateTestCases (std::vector<TestCase> const &functions)
{
...
std::vector<TestCase>
filterTests (std::vector<TestCase> const &testCases, TestSpec const &testSpec,
			 IConfig const &config)
{
...
void
TestRegistry::registerTest (TestCase const &testCase)
{
...
std::string
extractClassName (StringRef const &classOrQualifiedMethodName)
{
...
bool
TrackerContext::completedCycle () const
{
...
void
TrackerContext::setCurrentTracker (ITracker *tracker)
{
...
bool
TrackerBase::isComplete () const
{
  return m_runState == CompletedSuccessfully || m_runState == Failed;
}
bool
TrackerBase::isSuccessfullyCompleted () const
{
  return m_runState == CompletedSuccessfully;
}
bool
TrackerBase::isOpen () const
{
  return m_runState != NotStarted && !isComplete ();
}
bool
TrackerBase::hasChildren () const
{
  return !m_children.empty ();
}

void
TrackerBase::addChild (ITrackerPtr const &child)
{
...
bool
TrackerBase::isSectionTracker () const
{
  return false;
}
bool
TrackerBase::isGeneratorTracker () const
{
  return false;
}
...
void
TrackerBase::moveToParent ()
{
  assert (m_parent);
  m_ctx.setCurrentTracker (m_parent);
}
void
TrackerBase::moveToThis ()
{
...
bool
SectionTracker::isComplete () const
{
  bool complete = true;
...
bool
SectionTracker::isSectionTracker () const
{
  return true;
}
...
void
SectionTracker::addInitialFilters (std::vector<std::string> const &filters)
{
  if (!filters.empty ())
	{
...
void
SectionTracker::addNextFilters (std::vector<std::string> const &filters)
{
  if (filters.size () > 1)
...
std::vector<std::string> const &
SectionTracker::getFilters () const
{
  return m_filters;
}

std::string const &
SectionTracker::trimmedName () const
{
...
auto
makeTestInvoker (void (*testAsFunction) ()) noexcept -> ITestInvoker *
{
  return new (std::nothrow) TestInvokerAsFunction (testAsFunction);
}

NameAndTags::NameAndTags (StringRef const &name_,
						  StringRef const &tags_) noexcept : name (name_),
															 tags (tags_)
{
}
...
bool
TestSpec::NamePattern::matches (TestCaseInfo const &testCase) const
{
...
bool
TestSpec::TagPattern::matches (TestCaseInfo const &testCase) const
{
...
bool
TestSpec::Filter::matches (TestCaseInfo const &testCase) const
{
  return std::all_of (
...
bool
TestSpec::hasFilters () const
{
  return !m_filters.empty ();
}

bool
TestSpec::matches (TestCaseInfo const &testCase) const
{
...
const TestSpec::vectorStrings &
TestSpec::getInvalidArgs () const
{
...
bool
TestSpecParser::visitChar (char c)
{
...
bool
TestSpecParser::processNoneChar (char c)
{
  switch (c)
	{
	case ' ':
...
void
TestSpecParser::processNameChar (char c)
{
  if (c == '[')
	{
...
bool
TestSpecParser::processOtherChar (char c)
{
  if (!isControlChar (c))
	return false;
  m_substring += c;
...
void
TestSpecParser::startNewMode (Mode mode)
{
  m_mode = mode;
}
void
TestSpecParser::endMode ()
{
  switch (m_mode)
	{
	case Name:
...
bool
TestSpecParser::isControlChar (char c) const
{
  switch (m_mode)
	{
	default:
...
void
TestSpecParser::saveLastMode ()
{
  lastMode = m_mode;
}

void
TestSpecParser::revertBackToLastMode ()
{
  m_mode = lastMode;
}

bool
TestSpecParser::separate ()
{
...
std::string
TestSpecParser::preprocessPattern ()
{
...
TestSpec
parseTestSpec (std::string const &arg)
{
...
{
auto
estimateClockResolution () -> uint64_t
{
  uint64_t sum = 0;
...
auto
getEstimatedClockResolution () -> uint64_t
{
...
auto
Timer::getElapsedNanoseconds () const -> uint64_t
{
  return getCurrentNanosecondsSinceEpoch () - m_nanoseconds;
}
auto
Timer::getElapsedMicroseconds () const -> uint64_t
{
  return getElapsedNanoseconds () / 1000;
}
auto
Timer::getElapsedMilliseconds () const -> unsigned int
{
  return static_cast<unsigned int> (getElapsedMicroseconds () / 1000);
}
auto
Timer::getElapsedSeconds () const -> double
{
...
std::string
rawMemoryToString (const void *object, std::size_t size)
{
...
std::string
StringMaker<char const *>::convert (char const *str)
{
  if (str)
	{
	  return ::Catch::Detail::stringify (std::string{ str });
...
std::string
StringMaker<char *>::convert (char *str)
{
  if (str)
	{
	  return ::Catch::Detail::stringify (std::string{ str });
...
#ifdef CATCH_CONFIG_WCHAR
std::string
StringMaker<std::wstring>::convert (const std::wstring &wstr)
{
  std::string s;
  s.reserve (wstr.size ());
  for (auto c : wstr)
...
#ifdef CATCH_CONFIG_CPP17_STRING_VIEW
std::string
StringMaker<std::wstring_view>::convert (std::wstring_view str)
{
...
std::string
StringMaker<wchar_t const *>::convert (wchar_t const *str)
{
  if (str)
	{
...
std::string
StringMaker<wchar_t *>::convert (wchar_t *str)
{
  if (str)
	{
	  return ::Catch::Detail::stringify (std::wstring{ str });
...
#include <cstddef>
std::string
StringMaker<std::byte>::convert (std::byte value)
{
  return ::Catch::Detail::stringify (
...
std::string
StringMaker<long>::convert (long value)
{
  return ::Catch::Detail::stringify (static_cast<long long> (value));
}
std::string
...
std::string
StringMaker<unsigned int>::convert (unsigned int value)
{
...
std::string
StringMaker<bool>::convert (bool b)
{
  return b ? "true" : "false";
}

std::string
StringMaker<signed char>::convert (signed char value)
{
  if (value == '\r')
	{
	  return "'\\r'";
...
std::string
StringMaker<char>::convert (char c)
{
  return ::Catch::Detail::stringify (static_cast<signed char> (c));
}
std::string
StringMaker<unsigned char>::convert (unsigned char c)
{
...
std::string
StringMaker<float>::convert (float value)
{
...
std::string
ratio_string<std::atto>::symbol ()
{
  return "a";
}
std::string
ratio_string<std::femto>::symbol ()
{
  return "f";
}
std::string
ratio_string<std::pico>::symbol ()
{
  return "p";
}
std::string
ratio_string<std::nano>::symbol ()
{
  return "n";
}
std::string
ratio_string<std::micro>::symbol ()
{
  return "u";
}
std::string
ratio_string<std::milli>::symbol ()
{
  return "m";
}
...
bool
WildcardPattern::matches (std::string const &str) const
{
  switch (m_wildcard)
	{
	case NoWildcard:
...
std::string
WildcardPattern::normaliseString (std::string const &str) const
{
...
void
hexEscapeChar (std::ostream &os, unsigned char c)
{
...
bool
shouldIndent (XmlFormatting fmt)
{
  return !!(static_cast<std::underlying_type<XmlFormatting>::type> (
...
void
XmlEncode::encodeTo (std::ostream &os) const
{
  ...
  for (std::size_t idx = 0; idx < m_str.size (); ++idx)
	{
	  ...
	  switch (c)
		...
		default:
		  ...
		  // only the encoding format First check that this bytes is a valid
		  // lead byte: This means that it is not encoded as 1111 1XXX Or as
		  // 10XX XXXX
		  if (c < 0xC0 || c >= 0xF8)
			{
			  hexEscapeChar (os, c);
...
XmlWriter &
XmlWriter::startElement (std::string const &name, XmlFormatting fmt)
{
  ensureTagClosed ();
  newlineIfNecessary ();
  if (shouldIndent (fmt))
...
XmlWriter &
XmlWriter::writeText (std::string const &text, XmlFormatting fmt)
{
  if (!text.empty ())
	{
...
void
XmlWriter::writeStylesheetRef (std::string const &url)
{
...
void
XmlWriter::applyFormatting (XmlFormatting fmt)
{
...
{
void
prepareExpandedExpression (AssertionResult &result)
{
...
std::string
getFormattedDuration (double duration)
{
...
bool
shouldShowDuration (IConfig const &config, double duration)
{
...
std::string
serializeFilters (std::vector<std::string> const &container)
{
...
void
TestEventListenerBase::assertionStarting (AssertionInfo const &)
{
}

bool
TestEventListenerBase::assertionEnded (AssertionStats const &)
{
  return false;
}
...
void
printTotals (std::ostream &out, const Totals &totals)
{
...
private:
  ...
  void
  printResultType (Colour::Code colour, std::string const &passOrFail) const
  {
	if (!passOrFail.empty ())
	  {
		{
  ...
  void
  printIssue (std::string const &issue) const
  {
	stream << ' ' << issue;
  }
  ...
  void
  printReconstructedExpression () const
  {
  ...
  void
  printRemainingMessages (Colour::Code colour = dimColour ())
  {
	if (itMessage == messages.end ())
	  return;
...
std::string
CompactReporter::getDescription ()
{
  return "Reports test results on a single line, suitable for IDEs";
}

void
CompactReporter::noMatchingTestCases (std::string const &spec)
{
  stream << "No test cases matched '" << spec << '\'' << std::endl;
}

void
CompactReporter::assertionStarting (AssertionInfo const &)
{
}
...
void
CompactReporter::sectionEnded (SectionStats const &_sectionStats)
{
...
void
CompactReporter::testRunEnded (TestRunStats const &_testRunStats)
{
...
{
public:
  ConsoleAssertionPrinter &operator= (ConsoleAssertionPrinter const &)
	  = delete;
...
std::size_t
makeRatio (std::size_t number, std::size_t total)
{
  std::size_t ratio
...
std::size_t &
findMax (std::size_t &i, std::size_t &j, std::size_t &k)
{
  if (i > j && i > k)
	return i;
  else if (j > k)
...
public:
  ...
  auto
  unitsAsString () const -> std::string
  {
	switch (m_units)
	  {
  ...
  friend auto
  operator<< (std::ostream &os, Duration const &duration) -> std::ostream &
  {
...
public:
  ...
  auto
  columnInfos () const -> std::vector<ColumnInfo> const &
  {
  ...
  template <typename T>
  friend TablePrinter &
  operator<< (TablePrinter &tp, T const &value)
  {
	tp.m_oss << value;
	return tp;
  }
...
void
ConsoleReporter::noMatchingTestCases (std::string const &spec)
{
  stream << "No test cases matched '" << spec << '\'' << std::endl;
}

void
ConsoleReporter::reportInvalidArguments (std::string const &arg)
{
  stream << "Invalid Filter: " << arg << std::endl;
}

void
ConsoleReporter::assertionStarting (AssertionInfo const &)
{
}
...
void
ConsoleReporter::sectionStarting (SectionInfo const &_sectionInfo)
{
...
void
ConsoleReporter::sectionEnded (SectionStats const &_sectionStats)
{
  m_tablePrinter->close ();
...
#if defined(CATCH_CONFIG_ENABLE_BENCHMARKING)
void
ConsoleReporter::benchmarkPreparing (std::string const &name)
{
...
void
ConsoleReporter::benchmarkStarting (BenchmarkInfo const &info)
{
...
void
ConsoleReporter::benchmarkEnded (BenchmarkStats<> const &stats)
{
  if (m_config->benchmarkNoAnalysis ())
	{
...
void
ConsoleReporter::benchmarkFailed (std::string const &error)
{
...
void
ConsoleReporter::testCaseEnded (TestCaseStats const &_testCaseStats)
{
  m_tablePrinter->close ();
...
void
ConsoleReporter::testRunEnded (TestRunStats const &_testRunStats)
{
...
void
ConsoleReporter::testRunStarting (TestRunInfo const &_testInfo)
{
...
void
ConsoleReporter::lazyPrintWithoutClosingBenchmarkTable ()
{
...
void
ConsoleReporter::lazyPrintRunInfo ()
{
  stream << '\n' << getLineOfChars<'~'> () << '\n';
...
void
ConsoleReporter::lazyPrintGroupInfo ()
{
...
void
ConsoleReporter::printTestCaseAndSectionHeader ()
{
  assert (!m_sectionStack.empty ());
...
void
ConsoleReporter::printOpenHeader (std::string const &_name)
{
  stream << getLineOfChars<'-'> () << '\n';
  {
	Colour colourGuard (Colour::Headers);
...
// subsequent lines
void
ConsoleReporter::printHeaderString (std::string const &_string,
									std::size_t indent)
{
...
void
ConsoleReporter::printTotals (Totals const &totals)
{
  if (totals.testCases.total () == 0)
	{
...
void
ConsoleReporter::printTotalsDivider (Totals const &totals)
{
  if (totals.testCases.total () > 0)
	{
...
void
ConsoleReporter::printSummaryDivider ()
{
  stream << getLineOfChars<'-'> () << '\n';
}

void
ConsoleReporter::printTestFilters ()
{
...
std::string
fileNameTag (const std::vector<std::string> &tags)
{
  auto it
...
void
JunitReporter::noMatchingTestCases (std::string const & /*spec*/)
{
}

void
JunitReporter::testRunStarting (TestRunInfo const &runInfo)
{
...
void
JunitReporter::testGroupStarting (GroupInfo const &groupInfo)
{
  suiteTimer.start ();
...
void
JunitReporter::testCaseStarting (TestCaseInfo const &testCaseInfo)
{
  m_okToFail = testCaseInfo.okToFail ();
}

bool
JunitReporter::assertionEnded (AssertionStats const &assertionStats)
{
...
void
JunitReporter::testCaseEnded (TestCaseStats const &testCaseStats)
{
...
void
JunitReporter::testGroupEnded (TestGroupStats const &testGroupStats)
{
...
void
JunitReporter::testRunEndedCumulative ()
{
  xml.endElement ();
}

void
JunitReporter::writeGroup (TestGroupNode const &groupNode, double suiteTime)
{
...
void
JunitReporter::writeTestCase (TestCaseNode const &testCaseNode)
{
...
void
JunitReporter::writeAssertions (SectionNode const &sectionNode)
{
...
void
JunitReporter::writeAssertion (AssertionStats const &stats)
{
...
void
ListeningReporter::addListener (IStreamingReporterPtr &&listener)
{
  m_listeners.push_back (std::move (listener));
}

void
ListeningReporter::addReporter (IStreamingReporterPtr &&reporter)
{
...
std::set<Verbosity>
ListeningReporter::getSupportedVerbosities ()
{
  return std::set<Verbosity>{};
}

void
ListeningReporter::noMatchingTestCases (std::string const &spec)
{
...
void
ListeningReporter::reportInvalidArguments (std::string const &arg)
{
  for (auto const &listener : m_listeners)
	{
...
#if defined(CATCH_CONFIG_ENABLE_BENCHMARKING)
void
ListeningReporter::benchmarkPreparing (std::string const &name)
{
  for (auto const &listener : m_listeners)
	{
...
void
ListeningReporter::benchmarkFailed (std::string const &error)
{
  for (auto const &listener : m_listeners)
	{
...
void
ListeningReporter::testRunStarting (TestRunInfo const &testRunInfo)
{
  for (auto const &listener : m_listeners)
	{
...
void
ListeningReporter::testGroupStarting (GroupInfo const &groupInfo)
{
  for (auto const &listener : m_listeners)
	{
...
void
ListeningReporter::testCaseStarting (TestCaseInfo const &testInfo)
{
  for (auto const &listener : m_listeners)
	{
...
void
ListeningReporter::sectionStarting (SectionInfo const &sectionInfo)
{
  for (auto const &listener : m_listeners)
	{
...
void
ListeningReporter::sectionEnded (SectionStats const &sectionStats)
{
  for (auto const &listener : m_listeners)
	{
...
void
ListeningReporter::testRunEnded (TestRunStats const &testRunStats)
{
  for (auto const &listener : m_listeners)
	{
...
void
ListeningReporter::skipTest (TestCaseInfo const &testInfo)
{
  for (auto const &listener : m_listeners)
	{
...
bool
ListeningReporter::isMulti () const
{
  return true;
}
...
std::string
XmlReporter::getStylesheetRef () const
{
  return std::string ();
}

void
XmlReporter::writeSourceInfo (SourceLineInfo const &sourceInfo)
{
...
void
XmlReporter::noMatchingTestCases (std::string const &s)
{
  StreamingReporterBase::noMatchingTestCases (s);
}

void
XmlReporter::testRunStarting (TestRunInfo const &testInfo)
{
...
void
XmlReporter::testGroupStarting (GroupInfo const &groupInfo)
{
...
void
XmlReporter::testCaseStarting (TestCaseInfo const &testInfo)
{
...
void
XmlReporter::sectionStarting (SectionInfo const &sectionInfo)
{
...
void
XmlReporter::assertionStarting (AssertionInfo const &)
{
}

bool
XmlReporter::assertionEnded (AssertionStats const &assertionStats)
{
...
void
XmlReporter::sectionEnded (SectionStats const &sectionStats)
{
...
void
XmlReporter::testCaseEnded (TestCaseStats const &testCaseStats)
{
...
void
XmlReporter::testGroupEnded (TestGroupStats const &testGroupStats)
{
...
void
XmlReporter::testRunEnded (TestRunStats const &testRunStats)
{
...
#if defined(CATCH_CONFIG_ENABLE_BENCHMARKING)
void
XmlReporter::benchmarkPreparing (std::string const &name)
{
  m_xml.startElement ("BenchmarkResults").writeAttribute ("name", name);
}

void
XmlReporter::benchmarkStarting (BenchmarkInfo const &info)
{
...
void
XmlReporter::benchmarkFailed (std::string const &error)
{
...
extern "C" int
wmain (int argc, wchar_t *argv[], wchar_t *[])
{
#else
...
#define CATCH_REQUIRE_THROWS_MATCHES(expr, exceptionType, matcher)            \
  INTERNAL_CATCH_THROWS_MATCHES (                                             \
	  "CATCH_REQUIRE_THROWS_MATCHES", exceptionType,                          \
