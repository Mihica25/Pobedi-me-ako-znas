...
int
Memorija::getPlayer1Points ()
{
  return player1Points;
}

int
Memorija::getPlayer2Points ()
{
...
void
Memorija::initializeGame (QVector<int> &cardIdsVector)
{
  int indeks = 0;
	  ...
	  for (int col = 0; col < numCols; ++col)
		{
		  ...
		  connect (cardWidget, &CardWidget::clicked, this,
				   &Memorija::onCardClicked);
...
void
Memorija::onCardClicked (int idReveal)
{
...
void
Memorija::opponentsView (int card)
{
  ...
  if (turnedCardsOp.size () == 2)
	{
	  ...
	  if (pairsFound == totalPairs)
		{
		  sendMessage (server,
					   "MEMORIJA_END:" + QString::number (player1Points) + ":"
						   + QString::number (player2Points) + "\n");
		}
	}
}

void
Memorija::hideUnmatchedCards ()
{
...
void
Memorija::resetTurnedCards ()
{
  turnedCards.clear ();
}

void
Memorija::onReadyRead ()
{
...
void
Memorija::processServerMessage (QString serverMessage)
{
...
void
Memorija::sendMessage (QTcpSocket *socket, QString msg)
{
...
void
Memorija::blockWholeWindow (bool block)
{
