...
GamePhase
MojBrojLogic::getCurrentRound ()
{
  return currentRound;
}

int
MojBrojLogic::getTargetNumber ()
{
  return targetNumber;
}

void
MojBrojLogic::setTargetNumber (int tn)
{
  targetNumber = tn;
}

bool
MojBrojLogic::endGame ()
{
  targetNumber = 0;
...
void
MojBrojLogic::chooseNumber (int number)
{
...
void
MojBrojLogic::chooseOperation (const QString &operation)
{
  currentExpression.append (operation);
}

QPair<QString, QString>
MojBrojLogic::deleteLastInput ()
{
...
QString
MojBrojLogic::vectorToString (const QVector<QString> &vec)
{
  QString result;
...
bool
MojBrojLogic::validateExpression (const QString &expression) const
{
...
int
MojBrojLogic::evaluateExpression (const QString &expression) const
{
...
// Done
int
MojBrojLogic::submitSolution (const QString &solution,
