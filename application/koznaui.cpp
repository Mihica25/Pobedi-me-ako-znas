	...
	: QMainWindow (parent), ui (new Ui::KoZnaui), tajmer (new QTimer (this))
{
  ...
  connect (ui->pushButtonAns1, &QPushButton::clicked, this,
		   &KoZnaui::on_pushButtonAns1);
  connect (ui->pushButtonAns2, &QPushButton::clicked, this,
		   &KoZnaui::on_pushButtonAns2);
  connect (ui->pushButtonAns3, &QPushButton::clicked, this,
		   &KoZnaui::on_pushButtonAns3);
  connect (ui->pushButtonAns4, &QPushButton::clicked, this,
		   &KoZnaui::on_pushButtonAns4);
...
KoZnaui::KoZnaui (QWidget *parent, QTcpSocket *tcpSocket, QString player11,
				  QString player22, bool red, int player1Points1,
				  int player2Points2)
	: QMainWindow (parent), ui (new Ui::KoZnaui), tajmer (new QTimer (this))
{
  server = tcpSocket;
  ...
  connect (ui->pushButtonAns1, &QPushButton::clicked, this,
		   &KoZnaui::on_pushButtonAns1Multiplayer);
  connect (ui->pushButtonAns2, &QPushButton::clicked, this,
		   &KoZnaui::on_pushButtonAns2Multiplayer);
  connect (ui->pushButtonAns3, &QPushButton::clicked, this,
		   &KoZnaui::on_pushButtonAns3Multiplayer);
  connect (ui->pushButtonAns4, &QPushButton::clicked, this,
		   &KoZnaui::on_pushButtonAns4Multiplayer);
...
int
KoZnaui::getPlayer1Points ()
{
  return player1Points;
}

int
KoZnaui::getPlayer2Points ()
{
...
KoZnaui::~KoZnaui () { delete ui; }

void
KoZnaui::displayQuestion (int questionNumber)
{
  time = 45;
...
void
KoZnaui::generisiPitanja (QString pitanje)
{
...
void
KoZnaui::processServerMessage (QString serverMessage)
{
  ...
  if (serverMessage.startsWith ("POENI1:"))
	{
	  ...
	  qDebug () << "Vrednost po pit" << numberOfQuestion
				<< serverMessage.mid (7).toInt () << endl;
  ...
  if (serverMessage.startsWith ("POENI2:"))
	{
	  ...
	  qDebug () << "usaoo" << endl;
	  qDebug () << "Vrednosto po pitanjima:" << numberOfQuestion
				<< serverMessage.mid (7).toInt () << endl;
	  // qDebug() << po << endl;
  ...
  if (serverMessage.startsWith ("PODRUNDA"))
	{
	  ...
	  podrunda = new Podrundaui (nullptr, server, player1, player2,
								 player1Points, player2Points);
	  podrunda->show ();
	  connect (podrunda, &Podrundaui::gameEnded, this,
			   &KoZnaui::on_podrundaEnds, Qt::UniqueConnection);
	}
...
void
KoZnaui::sendMessage (QTcpSocket *socket, QString msg)
{
