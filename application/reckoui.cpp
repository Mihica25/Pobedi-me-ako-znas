...
// #include "ui_reckoui_copy.h"

ReckoUI::ReckoUI (QWidget *parent)
	: QMainWindow (parent), ui (new Ui::ReckoUI), recko (new Recko ()),
	  tajmer (new QTimer (this))
{
  ui->setupUi (this);
  setUpBackground ();
  setUpRows ();
  connect (ui->pbPotvrdi1, &QPushButton::clicked, this,
		   &ReckoUI::on_pbPotvrdi1);
  connect (ui->pbPotvrdi2, &QPushButton::clicked, this,
		   &ReckoUI::on_pbPotvrdi2);
  connect (ui->pbPotvrdi3, &QPushButton::clicked, this,
		   &ReckoUI::on_pbPotvrdi3);
  connect (ui->pbPotvrdi4, &QPushButton::clicked, this,
		   &ReckoUI::on_pbPotvrdi4);
  connect (ui->pbPotvrdi5, &QPushButton::clicked, this,
		   &ReckoUI::on_pbPotvrdi5);
...
ReckoUI::ReckoUI (QWidget *parent, QTcpSocket *tcpSocket, QString p1Username,
				  QString p2Username, bool red, int p1Points, int p2Points)
	: QMainWindow (parent), ui (new Ui::ReckoUI), recko (new Recko ()),
	  tajmer (new QTimer (this))
{
  server = tcpSocket;
...
ReckoUI::startGame ()
{
  ...
  if (turn)
	{
	  connect (ui->pbPotvrdi1, &QPushButton::clicked, this,
			   &ReckoUI::on_pbPotvrdi1Multiplayer);
	  connect (ui->pbPotvrdi2, &QPushButton::clicked, this,
			   &ReckoUI::on_pbPotvrdi2Multiplayer);
	  connect (ui->pbPotvrdi3, &QPushButton::clicked, this,
			   &ReckoUI::on_pbPotvrdi3Multiplayer);
	  connect (ui->pbPotvrdi4, &QPushButton::clicked, this,
			   &ReckoUI::on_pbPotvrdi4Multiplayer);
	  connect (ui->pbPotvrdi5, &QPushButton::clicked, this,
			   &ReckoUI::on_pbPotvrdi5Multiplayer);
...
ReckoUI::restartGame ()
{
  ...
  if (turn)
	{
	  disconnect (ui->pbPotvrdi1, &QPushButton::clicked, this,
				  &ReckoUI::on_pbPotvrdi1Multiplayer);
	  disconnect (ui->pbPotvrdi2, &QPushButton::clicked, this,
				  &ReckoUI::on_pbPotvrdi2Multiplayer);
	  disconnect (ui->pbPotvrdi3, &QPushButton::clicked, this,
				  &ReckoUI::on_pbPotvrdi3Multiplayer);
	  disconnect (ui->pbPotvrdi4, &QPushButton::clicked, this,
				  &ReckoUI::on_pbPotvrdi4Multiplayer);
	  disconnect (ui->pbPotvrdi5, &QPushButton::clicked, this,
				  &ReckoUI::on_pbPotvrdi5Multiplayer);
	  ...
	  if (lineEdit)
		{
		  ...
		  if (userInput.compare (recko->wordle.at (j), Qt::CaseInsensitive)
			  == 0)
			{
...
void
ReckoUI::disableRow (int index, bool disable)
{
  if (index > 4)
	{
	  return;
...
void
ReckoUI::processServerMessage (QString serverMessage)
{
...
void
ReckoUI::sendMessage (QTcpSocket *socket, QString msg)
{
...
int
ReckoUI::getPlayer1Points ()
{
  return player1Points;
}

int
ReckoUI::getPlayer2Points ()
{
