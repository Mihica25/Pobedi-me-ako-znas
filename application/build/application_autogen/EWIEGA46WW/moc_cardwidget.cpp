...
#define QT_MOC_LITERAL(idx, ofs, len)                                                                                  \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                                                           \
        len, qptrdiff(offsetof(qt_meta_stringdata_CardWidget_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_CardWidget_t qt_meta_stringdata_CardWidget = {
    {
        ...
        QT_MOC_LITERAL(3, 20, 3), // "idR"
        QT_MOC_LITERAL(4, 24, 6), // "reveal"
        QT_MOC_LITERAL(5, 31, 4)  // "hide"

    },
    "CardWidget\0clicked\0\0idR\0reveal\0hide"};
...
static const uint qt_meta_data_CardWidget[] = {
    ...
    4, 0, 32, 2, 0x0a /* Public */, 5, 0, 33, 2, 0x0a /* Public */,
...
void CardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        {
        case 0:
            _t->clicked((*reinterpret_cast<int(*)>(_a[1])));
            break;
        case 1:
            _t->reveal();
            break;
    ...
    else if (_c == QMetaObject::IndexOfMethod)
    {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CardWidget::clicked))
            {
                *result = 0;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject CardWidget::staticMetaObject = {
    {&QWidget::staticMetaObject, qt_meta_stringdata_CardWidget.data, qt_meta_data_CardWidget, qt_static_metacall,
     nullptr, nullptr}};
...
// SIGNAL 0
void CardWidget::clicked(int _t1)
{
