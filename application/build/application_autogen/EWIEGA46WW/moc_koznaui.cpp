...
#define QT_MOC_LITERAL(idx, ofs, len)                                                                                  \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                                                           \
        len, qptrdiff(offsetof(qt_meta_stringdata_KoZnaui_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_KoZnaui_t qt_meta_stringdata_KoZnaui = {
    {
        ...
        QT_MOC_LITERAL(20, 308, 5),  // "getUI"
        QT_MOC_LITERAL(21, 314, 12)  // "Ui::KoZnaui*"
    ...
    "on_podrundaEnds\0getUI\0Ui::KoZnaui*"};
...
static const uint qt_meta_data_KoZnaui[] = {
    ...
    1, 0, 109, 2, 0x06 /* Public */, 3, 0, 110, 2, 0x06 /* Public */, 4, 0, 111, 2, 0x06 /* Public */, 5, 0, 112, 2,
    0x06 /* Public */,

    // slots: name, argc, parameters, tag, flags
    6, 0, 113, 2, 0x0a /* Public */, 7, 0, 114, 2, 0x0a /* Public */, 8, 0, 115, 2, 0x0a /* Public */, 9, 0, 116, 2,
    0x0a /* Public */, 10, 0, 117, 2, 0x0a /* Public */, 11, 0, 118, 2, 0x0a /* Public */, 12, 0, 119, 2,
    0x0a /* Public */, 13, 0, 120, 2, 0x0a /* Public */, 14, 0, 121, 2, 0x0a /* Public */, 15, 0, 122, 2,
    0x0a /* Public */, 16, 0, 123, 2, 0x0a /* Public */, 17, 0, 124, 2, 0x0a /* Public */, 18, 0, 125, 2,
    0x0a /* Public */, 19, 0, 126, 2, 0x0a /* Public */, 20, 0, 127, 2, 0x0a /* Public */,
    ...
    QMetaType::Void, QMetaType::Void, QMetaType::Void, QMetaType::Void, QMetaType::Void, QMetaType::Void,
    QMetaType::Void, QMetaType::Void, 0x80000000 | 21,
...
void KoZnaui::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod)
    {
        ...
        case 7:
            ...
            break;
        case 8:
            _t->on_pushButtonAns1();
            break;
        case 9:
            _t->on_pushButtonAns2();
            break;
        case 10:
            _t->on_pushButtonAns3();
            break;
        case 11:
            _t->on_pushButtonAns4();
            break;
        case 12:
            _t->on_pushButtonAns1Multiplayer();
            break;
        case 13:
            _t->on_pushButtonAns2Multiplayer();
            break;
        case 14:
            _t->on_pushButtonAns3Multiplayer();
            break;
        case 15:
            _t->on_pushButtonAns4Multiplayer();
            break;
        case 16:
            _t->on_DALJE();
            break;
        case 17:
            ...
            break;
        case 18: {
            Ui::KoZnaui *_r = _t->getUI();
            if (_a[0])
                *reinterpret_cast<Ui::KoZnaui **>(_a[0]) = std::move(_r);
        }
        break;
        default:;
        }
...
QT_INIT_METAOBJECT const QMetaObject KoZnaui::staticMetaObject = {
    {&QMainWindow::staticMetaObject, qt_meta_stringdata_KoZnaui.data, qt_meta_data_KoZnaui, qt_static_metacall, nullptr,
     nullptr}};
